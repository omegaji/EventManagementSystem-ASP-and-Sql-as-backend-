...
public partial class birthday : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        str = "select * from upload where type='birthday' ";
        ...
        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
        {
            ...
            //{
            html.Append("<div class=''><img  style='height:200px; width:400px; max-width:500px' src='image/birthday/" + ds.Tables[0].Rows[i]["name"].ToString() + "' class='image'   > ");
